...
interface SurahDao {
    ...
    fun getFirst3SurahsWithPin(): Flow<List<SurahWithPinEmbedded>>
    ...
    fun getAllSurahsWithPin(): PagingSource<Int, SurahWithPinEmbedded>
    ...
    fun searchSurahsWithPin(query: String): PagingSource<Int, SurahWithPinEmbedded>
}